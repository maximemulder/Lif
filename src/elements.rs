...
pub const SYMBOL_PARENTHESIS_L:    Element = Element::new("PARENTHESIS_L");
...
pub const PRODUCTION_PROGRAM:     Element = Element::new("PROGRAM");
...
pub const PRODUCTION_EXPRESSIONS: Element = Element::new("EXPRESSIONS");
...
pub const PRODUCTION_STRUCTURE_LOOP: Element = Element::new("LOOP");
pub const PRODUCTION_STRUCTURE_WHILE: Element = Element::new("WHILE");
pub const PRODUCTION_STRUCTURE_DO_WHILE: Element = Element::new("DO_WHILE");
pub const PRODUCTION_STRUCTURE_FOR_IN: Element = Element::new("FOR_IN");
pub const PRODUCTION_STRUCTURE_DO: Element = Element::new("DO");
